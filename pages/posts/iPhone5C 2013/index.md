...
content: 注塑成型的聚碳酸酯外壳下隐藏着不锈钢结构框架。徽标是先在外壳背面进行移印，然后再涂上一层硬涂层，而文字图案则是用激光穿过硬涂层打在聚碳酸酯树脂上的。
cover: ["imgs/iPhone5C 2013/title_image.png", "imgs/iPhone5C 2013/title_mobile_image.png"]
...
注塑成型的聚碳酸酯外壳下隐藏着不锈钢结构框架。徽标是先在外壳背面进行移印，然后再涂上一层硬涂层，而文字图案则是用激光穿过硬涂层打在聚碳酸酯树脂上的。
