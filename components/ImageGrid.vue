...
<template>
  ...
  <section v-else-if="mode === 'grid'" class="grid-gallery gallery" grid="~ cols-1 lg:cols-2 xl:cols-3" style="gap: var(--gap);" :style="{ '--min-height': minHeight, '--max-height': maxHeight }">
